...
from Zadania.optymalizacja_biblioteka_zewnetrzna.weather_forecast import WeatherForecast
...
file_name = WeatherForecast("data_2.json")
...
print(file_name["Warszawa", "2025-12-12"])

my_generator = file_name.items()
